...
const Json2csvParser = require('json-2-csv').Parser;
var User = require('lib/models').User
var RegisteredVoter = require('lib/models').User
...
/**
 * Get topic voter summary by registered status
 *
 * @param {objectId} topicId 
 * @api public
 */

TopicSchema.statics.getTopicSummaryRegisteredStatus = function (topicId) {
