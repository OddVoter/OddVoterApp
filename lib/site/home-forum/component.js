...
export class HomeForum extends Component {
  ...
  renderVoterMatchResult() {
    if (this.state.showVoterMatchedMessage && !this.state.voterMatched) {
      return (
    ...
    } else if (this.state.showVoterMatchedMessage && this.state.voterMatched) {
      return (
